                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  RichText(text: TextSpan(
                                    ...
                                    fontSize: 25, fontWeight: FontWeight.bold,color: Color(0xffA42FC1),
                                  ),
                                    children: [TextSpan(
                                      text: " pt", style: TextStyle(
                                      fontSize: 20, fontWeight: FontWeight.bold,color: Color(0xffA42FC1),
                                    ),
                                    ),
                                    ]
                                  ),),
                    ...
                    width: MediaQuery.of(context).size.width/1.12,
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [BoxShadow(
                            blurRadius: 5,
                            spreadRadius: 3,
                            color: Color(0xffA42FC1).withValues(alpha: 0.7),
                            offset: Offset(0, 1),
                          ),
                        ]
                        ),
                                        ...
                                        Center(
                                          child: Row(
                                            children: [
                                              ...
                                              Text("$percentage%" ,style: TextStyle(
                                                fontSize: 25,fontWeight: FontWeight.w500,color: Color(0xffA42FC1),
                                              ),)
                                            ],
                                          ),
                                        ),
